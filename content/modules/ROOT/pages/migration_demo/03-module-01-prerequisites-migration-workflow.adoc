...
* **vcenter_hostname**: vCenter server address (`{vcenter_hostname}`)
* **vcenter_username/password**: Credentials for accessing vCenter
...
6. Verify the `vms_list` variable contains: `haproxy-{vcenter_full_user}`
