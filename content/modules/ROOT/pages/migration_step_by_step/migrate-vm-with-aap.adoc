...
openstack server add floating ip haproxy-{vcenter_full_user} {FLOATING_IP}
----
...
openstack volume delete haproxy-{vcenter_full_user}-202
openstack port delete haproxy-{vcenter_full_user}-NIC-0-VLAN-private-202
----
